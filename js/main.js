...
function createCar(engine, model, name, year) {
  return {
    engine,
    model,
    name,
...
let car = createCar(2000, 'Lacetti', 'Chevrolet', 2010);
let car2 = createCar(5000, 'FX50 AWD', 'Infinite', 2019);

// Examples of usage
// console.log(car.info());  // Output: Chevrolet Lacetti, 2000cc, year 2010, used
// console.log(car2.info()); // Output: Infinite FX50 AWD, 5000cc, year 2019, new
